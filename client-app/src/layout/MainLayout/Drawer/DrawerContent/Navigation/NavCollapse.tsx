...
interface Props {
  ...
  level: number;
  parentId: string;
  setSelectedItems: any; // proably string | undefined as function
  selectedItems: string | undefined;
  setSelectedLevel: any; // probably number as mobx update function
  selectedLevel: number;
}

const NavCollapse = observer(({ menu, level, parentId, setSelectedItems, selectedItems, setSelectedLevel, selectedLevel }: Props) => {
