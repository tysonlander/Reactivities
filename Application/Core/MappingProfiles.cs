...
namespace Application.Core
{
    public class MappingProfiles : AutoMapper.Profile
    {
        public MappingProfiles()
        {
            ...
            CreateMap<ActivityAttendee, AttendeeDto>() // should mapp to attendeeDto
            ...
            CreateMap<Comment, CommentDto>() // maps from -> to
                .ForMember(d => d.DisplayName, o => o.MapFrom(s => s.Author.DisplayName)) // to -> from
